import{j as e,r as h}from"./index-a8-kL1zu.js";import{u as m,N as g,c as b,a as f,d as p,O as u}from"./App-C6lX17cb.js";const j=[{path:"/map",icon:"🗺️",label:"Carte",roles:[],desc:"Carte interactive"},{path:"/dashboard",icon:"📊",label:"Dashboard",roles:[],desc:"KPI & statistiques"},{path:"/travaux",icon:"🏗️",label:"Travaux",roles:[],desc:"Ordres de travail"},{path:"/eligibilite",icon:"📡",label:"Éligibilité",roles:[],desc:"Vérifier la fibre"},{path:"/terrain",icon:"📱",label:"Terrain",roles:["admin","chef_projet","technicien"],desc:"Dessin mobile"},{path:"/catalogue",icon:"📦",label:"Catalogue",roles:[],desc:"Équipements"},{path:"/analytics",icon:"📈",label:"Analytics",roles:["admin","chef_projet","analyste"],desc:"Saturation & prédictions"},{path:"/import-dwg",icon:"📥",label:"Import DWG",roles:["admin","chef_projet","technicien"],desc:"Import GeoJSON/DWG"},{path:"/admin",icon:"⚙️",label:"Admin",roles:["admin"],desc:"Administration"}];function x({onClose:s}){var r,i;const{user:t,logout:d,hasRole:l}=m(),o={admin:"bg-red-900 text-red-300",chef_projet:"bg-purple-900 text-purple-300",technicien:"bg-blue-900 text-blue-300",commercial:"bg-green-900 text-green-300",analyste:"bg-yellow-900 text-yellow-300",invite:"bg-gray-800 text-gray-400"};return e.jsxs("div",{className:`w-64 bg-gray-900 border-r
                    ...
                    h-full`,children:[e.jsxs("div",{className:`p-5 border-b border-gray-700
                     ...
                     hover:text-white p-1`,children:"✕"})]}),e.jsx("nav",{className:`flex-1 p-3 space-y-1
                      overflow-y-auto`,children:j.map(n=>n.roles.length>0&&!l(...n.roles)?null:e.jsxs(g,{to:n.path,onClick:s,className:({isActive:c})=>`
      ...
      `,children:e.jsx(x,{onClose:()=>t(!1)})}),e.jsxs("div",{className:"flex-1 flex flex-col min-w-0 overflow-hidden",children:[e.jsx(N,{onMenuClick:()=>t(!s),sidebarOpen:s}),e.jsx("main",{className:"flex-1 overflow-auto",children:e.jsx(u,{})})]})]})}export{k as default};
