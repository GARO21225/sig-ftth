import{j as e}from"./index-BH5sPqCI.js";import{r as a,u as v,L as N}from"./vendor-react-BeK1MbjZ.js";import{u as w,z as S}from"./App-BH_BuV_2.js";import{a as C}from"./api-C4-va_VY.js";import"./vendor-charts-dkL-Ffi_.js";function L(){const[n,o]=a.useState(""),[r,c]=a.useState(""),[l,b]=a.useState(!1),[d,m]=a.useState(!1),[x,i]=a.useState(""),{login:g}=w(),j=v(),y=async t=>{var u,p,h;t.preventDefault(),m(!0),i("");try{const s=await C.post("/login",{email:n,mot_de_passe:r});g(s.data),S.success(`Bienvenue ${s.data.user.prenom} ! 👋`),j("/map")}catch(s){const f=((p=(u=s.response)==null?void 0:u.data)==null?void 0:p.detail)||"Erreur de connexion";i(f),((h=s.response)==null?void 0:h.status)===423&&i("🔒 Compte verrouillé. Réinitialisez votre mot de passe.")}finally{m(!1)}};return e.jsx("div",{className:`min-h-screen bg-gray-950
