import{j as e}from"./vendor-charts-Bv-qlnbU.js";import{r as a,u as v,L as N}from"./vendor-react-DI-t83gz.js";import{u as w}from"./index-BuHk5joC.js";import{a as S}from"./api-_5Sc3rdM.js";import{z as C}from"./vendor-ui-Bv7g2MqR.js";function L(){const[n,i]=a.useState(""),[r,c]=a.useState(""),[l,b]=a.useState(!1),[d,m]=a.useState(!1),[x,o]=a.useState(""),{login:g}=w(),f=v(),j=async t=>{var u,p,h;t.preventDefault(),m(!0),o("");try{const s=await S.post("/login",{email:n,mot_de_passe:r});g(s.data),C.success(`Bienvenue ${s.data.user.prenom} ! 👋`),f("/map")}catch(s){const y=((p=(u=s.response)==null?void 0:u.data)==null?void 0:p.detail)||"Erreur de connexion";o(y),((h=s.response)==null?void 0:h.status)===423&&o("🔒 Compte verrouillé. Réinitialisez votre mot de passe.")}finally{m(!1)}};return e.jsx("div",{className:`min-h-screen bg-gray-950
                    ...
                    p-4`,children:e.jsxs("div",{className:"w-full max-w-md",children:[e.jsxs("div",{className:"text-center mb-8",children:[e.jsx("div",{className:"text-6xl mb-4",children:"🌐"}),e.jsx("h1",{className:"text-3xl font-bold text-white",children:"SIG FTTH"}),e.jsx("p",{className:"text-gray-400 text-sm mt-2",children:"Système d'Information Géographique"})]}),e.jsxs("div",{className:`bg-gray-900 rounded-2xl p-8
                        ...
                        shadow-2xl`,children:[e.jsx("h2",{className:`text-xl font-bold
                         text-white mb-6`,children:"Connexion"}),e.jsxs("form",{onSubmit:j,className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{className:`text-sm text-gray-400
                                block mb-2`,children:"Adresse email"}),e.jsx("input",{type:"email",value:n,onChange:t=>i(t.target.value),placeholder:"votre@email.com",required:!0,autoComplete:"email",className:`w-full bg-gray-800 rounded-xl
                        ...
                        text-center mb-3`,children:"Comptes de démonstration"}),e.jsxs("div",{className:"space-y-2",children:[[{role:"👑 Admin",email:"admin@sig-ftth.ci",color:"blue"},{role:"💼 Commercial",email:"commercial@sig-ftth.ci",color:"green"},{role:"🔧 Technicien",email:"technicien@sig-ftth.ci",color:"orange"}].map(t=>e.jsxs("button",{onClick:()=>{i(t.email),c("Admin@2026!")},className:`w-full text-left px-3 py-2
