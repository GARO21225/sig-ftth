import{u as m,j as e,N as g,c as b,a as f,r as h,d as p,O as u}from"./index-mnWoQlB1.js";const j=[{path:"/map",icon:"🗺️",label:"Carte",roles:[],desc:"Carte interactive"},{path:"/dashboard",icon:"📊",label:"Dashboard",roles:[],desc:"KPI & statistiques"},{path:"/travaux",icon:"🏗️",label:"Travaux",roles:[],desc:"Ordres de travail"},{path:"/eligibilite",icon:"📡",label:"Éligibilité",roles:[],desc:"Vérifier la fibre"},{path:"/terrain",icon:"📱",label:"Terrain",roles:["admin","chef_projet","technicien"],desc:"Dessin mobile"},{path:"/catalogue",icon:"📦",label:"Catalogue",roles:[],desc:"Équipements"},{path:"/analytics",icon:"📈",label:"Analytics",roles:["admin","chef_projet","analyste"],desc:"Saturation & prédictions"},{path:"/import-dwg",icon:"📥",label:"Import DWG",roles:["admin","chef_projet","technicien"],desc:"Import GeoJSON/DWG"},{path:"/admin",icon:"⚙️",label:"Admin",roles:["admin"],desc:"Administration"}];function x({onClose:s}){var r,l;const{user:t,logout:d,hasRole:i}=m(),o={admin:"bg-red-900 text-red-300",chef_projet:"bg-purple-900 text-purple-300",technicien:"bg-blue-900 text-blue-300",commercial:"bg-green-900 text-green-300",analyste:"bg-yellow-900 text-yellow-300",invite:"bg-gray-800 text-gray-400"};return e.jsxs("div",{className:`w-64 bg-gray-900 border-r
                    ...
                    h-full`,children:[e.jsxs("div",{className:`p-5 border-b border-gray-700
                     ...
                     hover:text-white p-1`,children:"✕"})]}),e.jsx("nav",{className:`flex-1 p-3 space-y-1
                      overflow-y-auto`,children:j.map(n=>n.roles.length>0&&!i(...n.roles)?null:e.jsxs(g,{to:n.path,onClick:s,className:({isActive:c})=>`
                             ...
                             hover:text-white text-sm`,children:"✕"})]}),e.jsx("div",{className:"max-h-80 overflow-y-auto",children:r.length===0?e.jsx("div",{className:`p-6 text-center
                                 ...
                                 transition-colors`,children:e.jsxs("div",{className:`flex items-start
                                      gap-3`,children:[e.jsxs("span",{className:"text-lg",children:[a.type==="success"&&"✅",a.type==="error"&&"❌",a.type==="warning"&&"⚠️",a.type==="info"&&"ℹ️"]}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsx("p",{className:`text-sm
                                        ...
                                        text-gray-500
                                        mt-1`,children:new Date(a.timestamp).toLocaleTimeString("fr-FR")})]})]})},a.id))})]})]})]})]})}function w(){const[s,t]=h.useState(!0);return e.jsxs("div",{className:"flex h-screen bg-gray-950 overflow-hidden",children:[e.jsx("div",{className:`
      ...
      `,children:e.jsx(x,{onClose:()=>t(!1)})}),e.jsxs("div",{className:"flex-1 flex flex-col min-w-0 overflow-hidden",children:[e.jsx(N,{onMenuClick:()=>t(!s),sidebarOpen:s}),e.jsx("main",{className:"flex-1 overflow-auto",children:e.jsx(u,{})})]})]})}export{w as default};
