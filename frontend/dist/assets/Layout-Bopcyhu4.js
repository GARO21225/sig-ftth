import{j as e}from"./vendor-charts-Bv-qlnbU.js";import{f as m,h as g,u as f,r as h,O as b}from"./vendor-react-DI-t83gz.js";import{u as p,a as u}from"./index-BuHk5joC.js";import"./vendor-ui-Bv7g2MqR.js";const j=[{path:"/map",icon:"🗺️",label:"Carte",roles:[],desc:"Carte interactive"},{path:"/dashboard",icon:"📊",label:"Dashboard",roles:[],desc:"KPI & statistiques"},{path:"/travaux",icon:"🏗️",label:"Travaux",roles:[],desc:"Ordres de travail"},{path:"/eligibilite",icon:"📡",label:"Éligibilité",roles:[],desc:"Vérifier la fibre"},{path:"/terrain",icon:"📱",label:"Terrain",roles:["admin","chef_projet","technicien"],desc:"Dessin mobile"},{path:"/catalogue",icon:"📦",label:"Catalogue",roles:[],desc:"Équipements"},{path:"/analytics",icon:"📈",label:"Analytics",roles:["admin","chef_projet","analyste"],desc:"Saturation & prédictions"},{path:"/import-dwg",icon:"📥",label:"Import DWG",roles:["admin","chef_projet","technicien"],desc:"Import GeoJSON/DWG"},{path:"/admin",icon:"⚙️",label:"Admin",roles:["admin"],desc:"Administration"}];function x({onClose:s}){var r,i;const{user:t,logout:d,hasRole:l}=p(),o={admin:"bg-red-900 text-red-300",chef_projet:"bg-purple-900 text-purple-300",technicien:"bg-blue-900 text-blue-300",commercial:"bg-green-900 text-green-300",analyste:"bg-yellow-900 text-yellow-300",invite:"bg-gray-800 text-gray-400"};return e.jsxs("div",{className:`w-64 bg-gray-900 border-r
                    ...
                    h-full`,children:[e.jsxs("div",{className:`p-5 border-b border-gray-700
                     ...
                     hover:text-white p-1`,children:"✕"})]}),e.jsx("nav",{className:`flex-1 p-3 space-y-1
                      overflow-y-auto`,children:j.map(n=>n.roles.length>0&&!l(...n.roles)?null:e.jsxs(m,{to:n.path,onClick:s,className:({isActive:c})=>`
              ...
              `,children:[e.jsx("span",{className:"text-xl flex-shrink-0",children:n.icon}),e.jsxs("div",{className:"min-w-0",children:[e.jsx("div",{className:"font-medium",children:n.label}),e.jsx("div",{className:`text-xs opacity-60
                      ...
                      space-y-3`,children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsxs("div",{className:`w-10 h-10 bg-gradient-to-br
                          ...
                          text-sm flex-shrink-0`,children:[(r=t==null?void 0:t.prenom)==null?void 0:r[0],(i=t==null?void 0:t.nom)==null?void 0:i[0]]}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsxs("p",{className:`text-sm font-semibold
                     ...
                     transition-colors`,children:t?"◀":"☰"}),e.jsx("h2",{className:`font-semibold text-white
                       text-base hidden sm:block`,children:c})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsxs("div",{className:`hidden sm:flex items-center
                        ...
                        px-3 py-1.5 rounded-full`,children:[e.jsx("span",{className:`w-1.5 h-1.5 bg-green-400
                           rounded-full
                           animate-pulse`}),"En ligne"]}),e.jsxs("div",{className:"relative",children:[e.jsxs("button",{onClick:()=>{o(!l),l||n()},className:`relative p-2 text-gray-400
                       hover:text-white
                       hover:bg-gray-800 rounded-lg
                       transition-colors`,children:["🔔",i>0&&e.jsx("span",{className:`absolute -top-0.5
                               -right-0.5
                               bg-red-500 text-white
                               text-xs rounded-full
                               w-4 h-4 flex items-center
                               justify-center font-bold
                               text-[10px]`,children:i>9?"9+":i})]}),l&&e.jsxs("div",{className:`absolute right-0 top-12
                             ...
                             hover:text-white text-sm`,children:"✕"})]}),e.jsx("div",{className:"max-h-80 overflow-y-auto",children:r.length===0?e.jsx("div",{className:`p-6 text-center
                                 ...
                                 transition-colors`,children:e.jsxs("div",{className:`flex items-start
                                      gap-3`,children:[e.jsxs("span",{className:"text-lg",children:[a.type==="success"&&"✅",a.type==="error"&&"❌",a.type==="warning"&&"⚠️",a.type==="info"&&"ℹ️"]}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsx("p",{className:`text-sm
                                        ...
                                        text-gray-500
                                        mt-1`,children:new Date(a.timestamp).toLocaleTimeString("fr-FR")})]})]})},a.id))})]})]})]})]})}function S(){const[s,t]=h.useState(!0);return e.jsxs("div",{className:"flex h-screen bg-gray-950 overflow-hidden",children:[e.jsx("div",{className:`
      ...
      `,children:e.jsx(x,{onClose:()=>t(!1)})}),e.jsxs("div",{className:"flex-1 flex flex-col min-w-0 overflow-hidden",children:[e.jsx(y,{onMenuClick:()=>t(!s),sidebarOpen:s}),e.jsx("main",{className:"flex-1 overflow-auto",children:e.jsx(b,{})})]})]})}export{S as default};
