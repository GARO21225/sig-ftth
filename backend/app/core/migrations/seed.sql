...
INSERT INTO categorie_equipement (nom, icone, couleur, reseau)
VALUES
...
INSERT INTO type_equipement
    (code, nom, geom_type, est_standard, statut, icone, couleur, id_categorie)
SELECT v.code, v.nom, 'POINT', TRUE, 'valide', v.icone, v.couleur, c.id
...
INSERT INTO type_equipement
    (code, nom, geom_type, est_standard, statut, icone, couleur, id_categorie)
SELECT v.code, v.nom, 'LINESTRING', TRUE, 'valide', v.icone, v.couleur, c.id
FROM categorie_equipement c,
(VALUES ('CAB_OPT','Câble Optique','〰️','#3B82F6')) AS v(code,nom,icone,couleur)
WHERE c.nom = 'Télécom'
ON CONFLICT (code) DO NOTHING;
...
INSERT INTO equipe_travaux (nom, specialite, nb_membres)
VALUES
